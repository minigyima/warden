...
use Minigyima\Warden\Cache\ColdCacheManager;
use Minigyima\Warden\Cache\WarmCacheManager;
...
return [
    ...
    */
    ...
    'page_denied' => "You don't have permission the to use this object.",
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This option controls whether to create a default when the tables are
    | migrated.
    |
    */
